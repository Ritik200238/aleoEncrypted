...
const VERIFY_STEPS = [
  {
    ...
    title: 'Verify ZK tip circuit on-chain',
    desc: 'private_tips.aleo wraps credits.aleo/transfer_private. BHP256 receipt commitment stored in tip_receipts mapping — sender identity + balance hidden by Groth16 SNARK. Click to read the on-chain circuit:',
    url: 'https://api.explorer.provable.com/v1/testnet/program/private_tips.aleo',
    instruction: '→ Returns Leo assembly. The commit.bhp256 instruction confirms on-chain ZK computation. Send a tip in-app with Shield Wallet → copy TX ID → find tip_receipts mapping key.',
  },
  {
    ...
    title: 'Verify Merkle ZK circuit on-chain',
    desc: 'group_membership.aleo proves membership using an 8-level BHP256 Merkle tree. submit_feedback verifies the path ZK-circuit-side and stores a nullifier — identity never on-chain. Read the live circuit:',
    url: 'https://api.explorer.provable.com/v1/testnet/program/group_membership.aleo',
    instruction: '→ Returns Leo assembly with Merkle tree verification and BHP256 nullifier computation. The nullifiers mapping stores proof-of-send without identity.',
  },
  {
    ...
    title: 'Verify group_membership.aleo is live',
    desc: 'The flagship ZK contract (8-level Merkle membership proofs + nullifier anti-replay) deployed on Aleo testnet. View the deployment transaction:',
    url: 'https://explorer.aleo.org/transaction/at1ksfdjkpvsrvuqnp6zurgp9feqycjkqkths9pa5gmemxzaryl8s8q3stazt?network=testnet',
    instruction: '→ Shows the deployment TX for group_membership.aleo — the anonymous messaging ZK circuit. All 6 contracts deployed and live (see contract list below).',
  },
];
